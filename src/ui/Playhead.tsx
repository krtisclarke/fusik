...
import { beatToX, HEADER_W, ROW_H } from './layout';
...
export function Playhead({ trackCount }: { trackCount: number }) {
  ...
  return <div ref={ref} className="playhead" style={{ height: trackCount * ROW_H }} />;
}
